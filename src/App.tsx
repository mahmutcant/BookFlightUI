        ...
        <div className='w-3/4 bg-[#F6F4F8] rounded-xl flex flex-col'>
          <div className='flex items-center justify-between w-full'>
            ...
            <div className='flex gap-6 mx-4 bg-[#F6F4F8]'>
              <NavItems icon={tagIcon} title='Deals' isUserInfo={false} />
              <NavItems icon={earthIcon} title='Discover' isUserInfo={false} />
              <NavItems icon={userIcon} title='Log in' isUserInfo={true} />
            </div>
          </div>
